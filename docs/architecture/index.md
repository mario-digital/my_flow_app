...
- [My Flow Fullstack Architecture Document](#table-of-contents)
  ...
  - [14. Coding Standards](./14-coding-standards.md)
    - [Critical Fullstack Rules](./14-coding-standards.md#critical-fullstack-rules)
      - [1. Type Sharing Pattern](./14-coding-standards.md#1-type-sharing-pattern)
      - [2. API Call Conventions](./14-coding-standards.md#2-api-call-conventions)
      - [3. Environment Variable Access](./14-coding-standards.md#3-environment-variable-access)
      - [4. State Update Patterns](./14-coding-standards.md#4-state-update-patterns)
      - [5. Error Handling Standards](./14-coding-standards.md#5-error-handling-standards)
      - [6. Server Component Rules](./14-coding-standards.md#6-server-component-rules)
      - [7. Database Query Patterns](./14-coding-standards.md#7-database-query-patterns)
    - [Naming Conventions](./14-coding-standards.md#naming-conventions)
    - [File Organization Rules](./14-coding-standards.md#file-organization-rules)
    - [Import Order Standards](./14-coding-standards.md#import-order-standards)
    - [Design Decisions](./14-coding-standards.md#design-decisions)
