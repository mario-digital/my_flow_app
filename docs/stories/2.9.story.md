...
- [ ] **Task 1: Create React Context provider for context selection state** (AC: 2)
  - [ ] Create `my_flow_client/src/components/providers/context-selection-provider.tsx`
  - [ ] Add `'use client'` directive at top (Client Component)
  - [ ] Import React Context utilities: `createContext`, `useContext`, `useState`, `useEffect`, `ReactNode`
  - [ ] Define `ContextSelectionState` interface:
    ```typescript
  ...
  - [ ] Implement `ContextSelectionProvider` component:
    - Accept `children: ReactNode` and optional `defaultContextId?: string`
  ...
  - [ ] Implement `useCurrentContext()` hook:
    - Call `useContext(ContextSelectionContext)`
    - Throw error if used outside provider
    - Return current context state and setter
  - [ ] Export both provider and hook
  - [ ] Follow import order standards (external → internal → relative)

- [ ] **Task 2: Create QueryClientProvider wrapper component** (AC: 1)
  - [ ] Create `my_flow_client/src/components/providers/query-provider.tsx`
  - [ ] Add `'use client'` directive (Client Component required for QueryClient)
  ...
  - [ ] Create `QueryClient` instance with configuration:
    ...
    ```
  - [ ] Implement `QueryProvider` component accepting `children: ReactNode`
  - [ ] Wrap children with `<QueryClientProvider client={queryClient}>`
  - [ ] Export `QueryProvider` as default
  - [ ] Add JSDoc comment explaining purpose and configuration

- [ ] **Task 3: Update root layout to include providers** (AC: 1)
  - [ ] Open `my_flow_client/src/app/layout.tsx`
  - [ ] Import `QueryProvider` from '@/components/providers/query-provider'
  - [ ] Import `ContextSelectionProvider` from '@/components/providers/context-selection-provider'
...
- [ ] **Task 4: Update Navigation component to include ContextSwitcher** (AC: 4)
  ...
  - [ ] Import `useCurrentContext` from '@/components/providers/context-selection-provider'
...
- [ ] **Task 5: Create dashboard page layout structure** (AC: 3, 7)
...
- [ ] **Task 6: Implement FlowList integration with empty and loading states** (AC: 3)
...
- [ ] **Task 7: Implement ChatInterface integration** (AC: 3, 5)
...
- [ ] **Task 8: Implement responsive layout** (AC: 6)
...
- [ ] **Task 9: Add context auto-selection logic** (AC: 2)
...
- [ ] **Task 10: Verify all styling follows UX Component Styling Guide** (AC: 7)
...
- [ ] **Task 11: Handle edge cases and error states** (AC: 3)
...
- [ ] **Task 14: Code quality and compliance** (AC: 7)
...
- Providers: `my_flow_client/src/components/providers/`
  ...
  - `context-selection-provider.tsx` (NEW: React Context for current context ID)
