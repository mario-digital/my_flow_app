...
- [ ] **Task 1: Create Feature Branch** (AC: N/A - Development Workflow)
  - [ ] Create new branch from main: `git checkout -b story-1-2-logto-backend-auth`
  - [ ] Verify branch creation: `git branch` should show current branch as `story-1-2-logto-backend-auth`
  - [ ] All subsequent work should be done on this branch

- [ ] **Task 2: Create Logto Application in Logto Cloud Console** (AC: 1)
...
- [ ] **Task 3: Store Logto Credentials in 1Password Vault** (AC: 2)
  - [ ] Verify 1Password CLI is installed and authenticated: `op signin`
  - [ ] Verify "MyFlow Development" vault exists (created in Story 1.1)
  - [ ] Create 1Password item for backend Logto credentials:
    - `op item create --category=login --title="MyFlow Logto Backend" --vault="MyFlow Development"`
  - [ ] Add credential fields to the item:
    - `op item edit "MyFlow Logto Backend" LOGTO_ENDPOINT=<value>`
    - `op item edit "MyFlow Logto Backend" LOGTO_APP_ID=<value>`
    - `op item edit "MyFlow Logto Backend" LOGTO_APP_SECRET=<value>`
    - `op item edit "MyFlow Logto Backend" LOGTO_RESOURCE=<value>`
  - [ ] Update `.env.template` file at project root to include 1Password references:
    ```bash
...
- [ ] **Task 4: Update Backend Configuration to Include Logto Settings** (AC: 3)
...
- [ ] **Task 5: Install Python Dependencies for JWT Validation** (AC: 3, 4)
...
- [ ] **Task 6: Create Auth Middleware with JWT Validation** (AC: 3, 4)
...
- [ ] **Task 7: Create Protected Route Example** (AC: 5)
...
- [ ] **Task 8: Verify Unprotected Health Check Endpoint** (AC: 6)
  - [ ] Open `my_flow_api/src/main.py`
...
- [ ] **Task 9: Write Unit Tests for Auth Middleware** (AC: 7)
...
- [ ] **Task 10: Write Integration Tests for Protected Routes** (AC: 7)
...
- [ ] **Task 11: Verify Backend Runs with 1Password Secret Injection** (AC: 8)
...
- [ ] **Task 12: Run All Tests and Verify Coverage** (AC: 7)
...
- [ ] **Task 13: Update Documentation** (AC: 1-8)
