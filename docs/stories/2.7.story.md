...
- [ ] **Task 0: Verify and install dependencies** (AC: 2, 6)
  ...
  - [ ] Verify installation: Check `my_flow_client/package.json` for both dependencies
...
**Current Implementation (AC: 3):**

For this story, error handling uses basic `console.error()` logging:
...
**Future Enhancement (Epic 3+):**

The project will add toast notifications using shadcn/ui `toast` component:
...
- Add TODO comments for future toast integration
- Focus on correct optimistic update/rollback behavior
- Error handling infrastructure will be added in later stories
