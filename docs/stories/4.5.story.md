...
- [ ] **Task 1: Create TypeScript types for context summaries** (AC: 4)
...
- [ ] **Task 2: Create Next.js BFF API route for context summaries** (AC: 3)
...
- [ ] **Task 3: Create TanStack Query hook for context summaries** (AC: 3)
...
- [ ] **Task 4: Create progress bar component** (AC: 1, 2)
  - [ ] Create `my_flow_client/src/components/dashboard/context-progress-bar.tsx`
...
- [ ] **Task 5: Create context summary card component** (AC: 1, 2, 4)
...
- [ ] **Task 6: Create main context summary widget** (AC: 1, 2, 3, 4)
...
- [ ] **Task 7: Create unit tests for ContextProgressBar** (AC: 5)
  - [ ] Create `my_flow_client/src/components/dashboard/__tests__/context-progress-bar.test.tsx`
...
- [ ] **Task 8: Create unit tests for ContextSummaryCard** (AC: 5)
...
- [ ] **Task 9: Create unit tests for ContextSummaryWidget** (AC: 5)
...
- [ ] **Task 10: Create unit tests for useContextSummaries hook** (AC: 5)
...
- [ ] **Task 14: Code quality and compliance** (AC: All)
...
- [ ] **Task 15: Integration with context switcher** (AC: 1)
